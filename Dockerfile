...
RUN go build -ldflags "-s -w -X 'github.com/QuantumNous/new-api/common.Version=$(cat VERSION)'" -o new-api \
    && go build -ldflags "-s -w -X 'github.com/QuantumNous/new-api/common.Version=$(cat VERSION)'" -o migrate-lawhub-skills ./cmd/migrate-lawhub-skills
...
COPY --from=builder2 /build/new-api /build/migrate-lawhub-skills /
