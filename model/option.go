...
func InitOptionMap() {
	...
	common.OptionMap["ModelOriginalPrice"] = ratio_setting.ModelOriginalPrice2JSONString()
...
func updateOptionMap(key string, value string) (err error) {
	...
	case "ModelOriginalPrice":
		err = ratio_setting.UpdateModelOriginalPriceByJSONString(value)
	case "CacheRatio":
