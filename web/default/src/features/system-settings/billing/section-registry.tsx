    ...
    build: (settings: BillingSettings) => (
      <PaymentSettingsSection
        defaultValues={{
          ...
          ManualTopUpEnabled: settings.ManualTopUpEnabled ?? false,
          ManualTopUpMinTopUp: settings.ManualTopUpMinTopUp ?? 1,
          ManualTopUpWechatQRCode: settings.ManualTopUpWechatQRCode ?? '',
          ManualTopUpAlipayQRCode: settings.ManualTopUpAlipayQRCode ?? '',
          ManualTopUpInstructions: settings.ManualTopUpInstructions ?? '',
